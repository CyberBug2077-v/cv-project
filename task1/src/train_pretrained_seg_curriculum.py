"""
Fine-tune the pretrained segmentation model with Dice loss and patch curriculum sampling.
...
Usage:
    conda run -n ML python3 src/train_pretrained_seg_curriculum.py

Saves to: outputs_curriculum/pretrained_seg/
  - best_model.pth
  - last_model.pth
...
OUTPUT_DIR         = pathlib.Path("outputs_curriculum/pretrained_seg")
