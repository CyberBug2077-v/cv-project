"""
Fine-tune the pretrained segmentation model with Dice plus cross-entropy loss.
...
Usage:
    conda run -n ML python3 src/train_pretrained_seg_dice_ce.py

Saves to: outputs_dice_ce/pretrained_seg/
  - best_model.pth
  - last_model.pth
  - training_log.json
"""
...
OUTPUT_DIR = pathlib.Path("outputs_dice_ce/pretrained_seg")
