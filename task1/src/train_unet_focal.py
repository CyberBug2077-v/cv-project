"""
Train the end-to-end U-Net with focal loss.

Focal loss down-weights easy examples, focusing gradient on hard/minority pixels.
Otherwise identical to train_unet.py.

Usage:
    conda run -n ML python3 src/train_unet_focal.py

Saves to: outputs_focal/unet/
  - best_model.pth
  - last_model.pth
  - training_log.json
"""
...
LR         = 1e-4
GAMMA      = 2.0
OUTPUT_DIR = pathlib.Path("outputs_focal/unet")
